  ...
  return (
    <main className="min-h-screen pb-24">
      ...
      <ScrollReveal direction="none">
        <section className="relative pt-32 pb-20 px-4 md:px-6 max-w-7xl mx-auto text-center">
          ...
          <ScrollReveal direction="up" delay={0.6}>
            <div className="flex flex-wrap justify-center gap-4">
              <a href="#pricing" className="button-premium">
                Get Started Now
              </a>
              <a href="#trial" className="px-10 py-4 bg-slate-100 hover:bg-slate-200 text-slate-900 font-bold rounded-2xl border border-slate-200 transition-all">
                Watch Trial Videos
              </a>
            </div>
          </ScrollReveal>
      ...
      {/* Final CTA Magnet */}
      <ScrollReveal direction="none">
        <section className="py-24 max-w-7xl mx-auto px-4 md:px-6 mb-24">
          <div className="relative bg-slate-900 rounded-[3rem] p-12 md:p-24 overflow-hidden text-center group">
            ...
            <div className="relative z-10">
              <ScrollReveal direction="up" delay={0.2}>
                <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight">Your Future Self is Waiting. <br /><span className="text-violet-400">Unlock Your Potential Today.</span></h2>
              </ScrollReveal>
              <ScrollReveal direction="up" delay={0.4}>
                <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-12 font-medium">Join 25,000+ students already leveling up their careers with our premium courses.</p>
              </ScrollReveal>
              <ScrollReveal direction="up" delay={0.6}>
                <a href="/login" className="inline-flex items-center gap-3 px-12 py-5 bg-white text-slate-900 text-xl font-black rounded-2xl hover:bg-slate-100 transition-all hover:scale-105 shadow-2xl shadow-white/10">
