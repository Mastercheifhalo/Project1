        ...
        <main className="min-h-screen pt-32 pb-20 px-4 md:px-6 flex items-center justify-center">
            ...
            <div className="w-full max-w-md">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-black tracking-tight mb-2 text-slate-900">Welcome Back</h1>
                ...
                <div className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-2xl shadow-slate-200/50">
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="text-right mt-3">
                                <a href="#" className="text-xs text-violet-600 font-bold hover:text-violet-500 transition-colors">Forgot password?</a>
                            </div>
                        </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-slate-50 text-center">
                        <p className="text-slate-500 text-sm font-medium">
                            ...
                            <Link href="/signup" className="text-violet-600 font-black hover:text-violet-500 transition-colors">
                                Create an account
                            </Link>
                        </p>
                    </div>
