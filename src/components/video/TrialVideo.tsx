...
export default function TrialVideo({ title, thumbnail, isUnlocked = false }: TrialVideoProps) {
  return (
    <div className="relative group overflow-hidden rounded-[2rem] border border-slate-100 bg-slate-50 shadow-sm transition-all hover:shadow-xl hover:border-slate-200 aspect-video w-full">
      <img
        src={thumbnail}
        alt={title}
